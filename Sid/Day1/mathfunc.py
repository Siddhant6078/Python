...
# exp(x)------- This method returns exponential of x: ex.
...
# max(x,y)-------- The largest of its arguments: the value closest to positive infinity
print "max(80, 100, 1000) : ", max(80, 100, 1000)
print "max(-20, 100, 400) : ", max(-20, 100, 400)
print "max(-80, -20, -10) : ", max(-80, -20, -10)
print "max(0, 100, -400) : ", max(0, 100, -400)

# min(x,y)--------- The smallest of its arguments: the value closest to negative infinity 
